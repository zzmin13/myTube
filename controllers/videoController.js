...
var videoDetail = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, res) {
    var id, user, video, recommendVideos, commentIDs, comments, comment, i;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            return _Video["default"].find({}).sort({
              views: -1
            }).limit(5).populate("creator");

          case 7:
            recommendVideos = _context4.sent;
            commentIDs = [];
            video.comments.map(function (element) {
              return commentIDs.push(element.id);
            });
            comments = [];
            i = 0;

          case 12:
            if (!(i < commentIDs.length)) {
              _context4.next = 20;
              break;
            }

            _context4.next = 15;
            return _Comment["default"].findById(commentIDs[i]).populate("creator");
    ...
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 16:
            res.redirect(_routes["default"].home); //비디오 삭제가 성공하던 실패하던 home으로 간다.
